...
# Special feature to run arenas testing
hg clone ssh://hg@bitbucket.org/osrf/vrc_arenas $WORKSPACE/vrc_arenas
mkdir $WORKSPACE/vrc_arenas/build
cd $WORKSPACE/vrc_arenas/build
cmake $WORKSPACE/vrc_arenas -DCMAKE_INSTALL_PREFIX=/usr ${ARENAS_TEST_SUITE_STR}
make -j${MAKE_JOBS} install
. /usr/share/vrc_arenas/setup.sh
ROS_TEST_RESULTS_DIR=$WORKSPACE/vrc_arenas/build/test_results make test ARGS="-VV" || true
ROS_TEST_RESULTS_DIR=$WORKSPACE/vrc_arenas/build/test_results rosrun rosunit clean_junit_xml.py
