...
apt-get install -y ${BASE_DEPENDENCIES} ros-${ROS_DISTRO}-xacro ros-${ROS_DISTRO}-ros osrf-common libboost-dev ros-${ROS_DISTRO}-image-common ros-${ROS_DISTRO}-ros-comm ros-${ROS_DISTRO}-catkin ros-${ROS_DISTRO}-common-msgs libqt4-dev
