...
echo "TODO: Using nightly gazebo, sandia and osrf-common packages until end of VRC"
DRCSIM_FULL_DEPENDENCIES="${DRCSIM_BASE_DEPENDENCIES} sandia-hand-nightly osrf-common-nightly ${GAZEBO_DEB_PACKAGE}"
