...
# Tests options
[[ -z ${BREW_ENABLE_TESTS} ]] && BREW_ENABLE_TESTS=true

# Build bundle options
[[ -z ${BREW_BUILD_BUNDLE} ]] && BREW_BUILD_BUNDLE=false

if $BREW_BUILD_BUNDLE; then
  BREW_ENABLE_TESTS=false
  CMAKE_EXTRA_PARAMETERS="-DBUILD_OSX_BUNDLE:BOOL=True"
fi
...
cmake ${CMAKE_EXTRA_PARAMETERS} \
      -DCMAKE_BUILD_TYPE=RelWithDebInfo \
      -DCMAKE_INSTALL_PREFIX=/usr/local/Cellar/${PROJECT}/HEAD \
      -DENABLE_TESTS_COMPILATION=${BREW_ENABLE_TESTS} \
