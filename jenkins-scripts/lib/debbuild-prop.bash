...
if $PRIVATE_REPO; then
  BITBUCKET_URL=ssh://bitbucket.org/${BITBUCKET_REPO}/$PACKAGE-release
else
  BITBUCKET_URL=https://bitbucket.org/${BITBUCKET_REPO}/$PACKAGE-release
fi

hg clone \$BITBUCKET_URL /tmp/$PACKAGE-release 
